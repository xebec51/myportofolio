...
const socialLinks = [
    ...
    { 
        name: 'LinkedIn', 
        href: 'https://www.linkedin.com/in/muh-rinaldi-ruslan',
    ...
    { 
        ...
        iconPath: "M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" 
    },
    { 
        name: 'Facebook', 
    ...
    { 
        name: 'TikTok', 
        href: 'https://www.tiktok.com/@rinaldiruslan', 
        iconPath: "M21.28 11.69c-1.72 0-3.3-.47-4.68-1.29v5.88c0 3.36-2.73 6.08-6.08 6.08-3.36 0-6.08-2.73-6.08-6.08 0-3.35 2.73-6.08 6.08-6.08 1.12 0 2.18.31 3.09.85v2.36a3.72 3.72 0 0 0-3.09-1.62 3.72 3.72 0 0 0-3.72 3.72c0 2.05 1.67 3.72 3.72 3.72 2.04 0 3.71-1.67 3.72-3.72V0h2.26c.17 1.64.56 3.23 1.17 4.73 1.38.82 2.96 1.29 4.68 1.29v2.67z" 
    }
];
...
export default function Footer() {
    ...
    return (
        <motion.footer 
            ...
            viewport={{ once: true }}
            className="bg-gray-900 text-white pt-16 pb-8 border-t border-gray-800"
        >
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    {/* Kolom 2: Navigasi */}
                    <div>
                        <h3 className="text-lg font-semibold mb-4 text-white border-b-2 border-red-600 w-fit pb-1">Navigation</h3>
                        <ul className="space-y-2">
                            {footerLinks.map((link) => (
                                <li key={link.name}>
                                    ...
                                    >
                                        <span className="text-red-600 opacity-0 -ml-2 group-hover:ml-0 group-hover:opacity-100 transition-all duration-300">›</span>
                                        {link.name}
                                    </Link>
                                </li>
                            ))}
                    ...
                    <div>
                        <h3 className="text-lg font-semibold mb-4 text-white border-b-2 border-red-600 w-fit pb-1">Follow Me</h3>
