            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center max-w-7xl mx-auto">
                    ...
                    <div className="flex flex-col items-center lg:items-start text-center lg:text-left z-10 order-2 lg:order-1">
                        ...
                        {/* Greeting */}
                        <h1 className="text-gray-900 text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-extrabold mb-3 tracking-tight leading-tight">
                            Hi, I&apos;m <span className="text-red-600">Naldi</span> 
                            <span className="inline-block animate-wave origin-[70%_70%] ml-2">👋</span>
                        </h1>
                        
                        {/* Animated Role */}
                        <div className="h-10 lg:h-12 mb-6 flex items-center justify-center lg:justify-start w-full">
                        ...
                        <p className="text-gray-600 text-sm sm:text-base lg:text-lg mb-8 max-w-xl leading-relaxed px-4 lg:px-0">
                    ...
                    <div className="w-full flex justify-center lg:justify-end relative order-1 lg:order-2">
                        ...
                        <div className="relative w-[300px] h-[300px] sm:w-[350px] sm:h-[350px] lg:w-[420px] lg:h-[420px] flex items-center justify-center">
                            ...
                            {/* JavaScript (Yellow) - Top Left */}
                            <TechIcon 
                                position="top-2 left-2 sm:top-4 sm:left-4 lg:top-8 lg:left-0"
                                delay="0s"
                            ...
                            {/* Python (Blue) - Top Right */}
                            <TechIcon 
                                position="top-4 right-2 sm:top-6 sm:right-4 lg:top-8 lg:-right-4"
                                delay="1.5s"
                                color="text-blue-500"
                                label="Python"
                                iconPath="M14.25.75l-.986.514c-2.667 1.392-1.743 4.294-1.743 4.294H8.937s-3.703.262-3.703 3.981v.633h3.73v.795H2.26S.36 9.736.36 13.93c0 4.238 3.582 4.134 3.582 4.134h2.875s.328-3.678 3.953-3.678h4.262s3.105-.408 3.105-3.433V8.395c0-3.219-3.887-7.645-3.887-7.645zm-5.704 2.87c.57 0 1.036.466 1.036 1.036 0 .57-.466 1.036-1.036 1.036-.57 0-1.036-.466-1.036-1.036 0-.57.466-1.036 1.036-1.036z"
                            />

                            {/* React (Cyan) - Bottom Right */}
                            <TechIcon 
                                position="bottom-10 right-0 sm:bottom-12 sm:right-2 lg:bottom-12 lg:-right-8"
                                delay="0.8s"
                                color="text-cyan-400"
                                label="React"
                            ...
                            {/* AI/Brain (Red) - Bottom Left */}
                            <TechIcon 
                                position="bottom-2 left-2 sm:bottom-4 sm:left-4 lg:bottom-8 lg:left-0"
                                delay="2.2s"
                                color="text-red-600"
...
// StatPill: Layout Horizontal dengan ukuran teks yang lebih kecil dan proporsional
const StatPill = ({ label, value, iconPath }: { label: string, value: string, iconPath: string }) => (
    <div className="flex items-center bg-red-700 p-3 pr-4 rounded-3xl shadow-lg hover:-translate-y-1 transition-all duration-300 hover:shadow-xl w-auto">
        ...
        {/* Text Content - Ukuran teks diperkecil */}
...
// TechIcon: Komponen untuk tech stack icons yang mengambang
const TechIcon = ({ 
    position, 
    delay, 
    color, 
    ...
    <div 
        // PERBAIKAN: Menambahkan 'animate-float' secara eksplisit di sini
        ...
        style={{ 
            ...
            // Opsional: Jika animasi masih tidak jalan, kita paksa dengan style inline
            animationName: 'float',
