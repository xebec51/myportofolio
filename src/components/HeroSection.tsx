                        ...
                        >
                            <Link href="#projects" className="w-full sm:w-auto">
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    className="w-full flex items-center justify-center px-8 py-3.5 text-sm font-bold text-white bg-gray-900 rounded-lg hover:bg-red-600 transition-colors duration-300 shadow-lg"
                                >
                                    Lihat Proyek
                                </motion.button>
                            </Link>
                            <Link href="/Curriculum_Vitae_Muh.Rinaldi_Ruslan.pdf" target="_blank" className="w-full sm:w-auto">
                                <motion.button
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                    className="w-full flex items-center justify-center px-8 py-3.5 text-sm font-bold text-gray-900 bg-white border-2 border-gray-200 rounded-lg hover:border-red-600 hover:text-red-600 transition-colors duration-300 shadow-sm"
                                >
                                    Unduh CV
                                </motion.button>
                            </Link>
