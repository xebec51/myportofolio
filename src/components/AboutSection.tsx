...
export default function AboutSection() {
    return (
        <section id="about" className="py-20 md:py-32 bg-gray-50 dark:bg-gray-900 overflow-hidden">
            <div className="container mx-auto px-6">
                ...
                <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
                    ...
                    <div 
                        ...
                        data-aos-delay="200"
                    >
                        <div className="relative w-[280px] h-[350px] sm:w-[320px] sm:h-[400px] rounded-2xl overflow-hidden shadow-2xl group border-4 border-gray-100 dark:border-gray-800">
                            <Image
                                src="/profile1.jpg"
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
                            <Link 
                                href="/profile" 
                                className="inline-flex items-center px-8 py-3 text-base font-bold text-white bg-gray-900 dark:bg-red-600 rounded-lg hover:bg-red-600 dark:hover:bg-red-500 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 group"
                            >
                                View Full Profile
