...
export default function ProjectsSection() {
    ...
    return (
        <section id="projects" className="py-20 md:py-24 bg-white dark:bg-gray-950 relative overflow-hidden">
            <div className="container mx-auto px-4 sm:px-6 relative z-10">
                ...
                <div className="text-center mb-12 md:mb-16">
                    <motion.h2 
                        ...
                        viewport={{ once: true }}
                        className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-900 dark:text-white mb-3 md:mb-4 tracking-tight"
                    >
                        Featured Projects
                    </motion.h2>
                    <motion.p
                        ...
                        viewport={{ once: true }}
                        className="text-sm md:text-lg text-gray-500 dark:text-gray-400 max-w-2xl mx-auto"
                    >
                    ...
                    <AnimatePresence>
                        {displayedProjects.map((project, index) => (
                            <motion.div
                                ...
                                className="group cursor-pointer bg-white dark:bg-gray-800 rounded-xl md:rounded-2xl overflow-hidden shadow-sm hover:shadow-xl border border-gray-200 dark:border-gray-700 hover:border-red-100 dark:hover:border-red-500/40 flex flex-col h-full transition-all duration-300"
                            >
                                ...
                                <div className="p-3 md:p-5 flex flex-col grow">
                                    <div className="flex justify-between items-start mb-2">
                                        ...
                                        <h3 className="font-bold text-gray-900 dark:text-white text-xs sm:text-sm md:text-lg leading-tight group-hover:text-red-600 dark:group-hover:text-red-500 transition-colors line-clamp-2">
                                            {project.title}
                                        </h3>
                                    </div>

                                    {/* Deskripsi disembunyikan di layar SANGAT kecil, muncul di tablet */}
                                    <p className="hidden sm:block text-xs md:text-sm text-gray-500 dark:text-gray-400 line-clamp-2 mb-3 md:mb-4">
                                    ...
                                    <div className="mt-auto flex flex-wrap gap-1.5 md:gap-2">
                                        {project.techStack.slice(0, 3).map((tech, idx) => (
                                            <span key={idx} className="px-2 py-0.5 md:px-2.5 md:py-1 bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-700 rounded-md text-[10px] md:text-xs font-medium text-gray-600 dark:text-gray-300">
                                                {tech}
                                            </span>
                                        ))}
                                        {project.techStack.length > 3 && (
                                            <span className="px-2 py-0.5 md:px-2.5 md:py-1 bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-700 rounded-md text-[10px] md:text-xs font-medium text-gray-400 dark:text-gray-500">
                                                +{project.techStack.length - 3}
                                            </span>
                                        )}
                                    </div>
                ...
                {selectedProject && (
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="w-full max-w-4xl bg-white dark:bg-gray-900 rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl relative flex flex-col max-h-[90vh]"
                        ...
                        >
                            ...
                            <div className="overflow-y-auto custom-scrollbar grow">
                                ...
                                <div className="p-6 md:p-8">
                                    ...
                                    <p className="text-base md:text-lg text-gray-600 dark:text-gray-400 leading-relaxed mb-6 md:mb-8">
                                        {selectedProject.description}
                                    </p>

                                    <div className="mb-6 md:mb-8">
                                        <h4 className="text-xs md:text-sm font-bold text-gray-900 dark:text-white uppercase tracking-wider mb-3 md:mb-4">Technologies</h4>
                                        <div className="flex flex-wrap gap-2">
                                            {selectedProject.techStack.map((tech, idx) => (
                                                <span key={idx} className="px-3 py-1 bg-red-50 dark:bg-red-500/10 text-red-700 dark:text-red-400 border border-red-100 dark:border-red-500/20 rounded-lg text-xs md:text-sm font-medium">
                                                    {tech}
                                                </span>
                                            ))}
                                        </div>
                            ...
                            <div className="p-5 md:p-6 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 flex flex-col sm:flex-row gap-3 md:gap-4 shrink-0">
                                <Link
                                    href={selectedProject.githubLink}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-gray-900 dark:bg-gray-800 text-white rounded-xl font-bold hover:bg-gray-800 dark:hover:bg-gray-700 transition-all active:scale-[0.98] text-sm md:text-base"
                                >
                                ...
                                {selectedProject.liveDemoLink !== "#" ? (
                                    <Link
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex-1 flex items-center justify-center gap-2 px-6 py-3 border-2 rounded-xl font-bold transition-all active:scale-[0.98] text-sm md:text-base border-red-600 text-red-600 dark:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10"
                                    >
                                    ...
                                    <span
                                        aria-disabled="true"
                                        className="flex-1 flex items-center justify-center gap-2 px-6 py-3 border-2 rounded-xl font-bold text-sm md:text-base border-gray-200 dark:border-gray-700 text-gray-400 dark:text-gray-600 cursor-not-allowed"
                                    >
